...
};gdjs.ShopCode.asyncCallback12642524 = function (runtimeScene, asyncObjectsList) {
...
gdjs.ShopCode.idToCallbackMap.set(12642524, gdjs.ShopCode.asyncCallback12642524);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.01), (runtimeScene) => (gdjs.ShopCode.asyncCallback12642524(runtimeScene, asyncObjectsList)), 12642524, asyncObjectsList);
}
}
